...
The second of five hash-locks landed on 2026-08-21. `contracts/gate_rule.v1.yaml` decides whether a proposed policy patch is promoted or rolled back. It is hash-locked at `cff9f52929397efb`, recorded in `docs/proof/d2-gate-rule-freeze.json` with the commit that carries it.
