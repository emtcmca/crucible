...
echo "  --   $CRUCIBLE_POLICIES_BUCKET   $SA_ARMORER            NO ROLE (asserted == 0 by infra/verify_iam.py)"
...
echo "                   an IAM Deny policy. data-spec 4.3 layer 3 is NOT BUILT;"
echo "                   infra/deny-armorer.sh does not exist. The layers that DO"
echo "                   exist are the absent grant and the captured 403."
echo ""
echo "Bindings applied. THIS SCRIPT'S EXIT CODE IS NOT THE EVIDENCE."
echo "Run: python infra/verify_iam.py"
