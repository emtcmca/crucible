...
GATES = {
    ...
    "G4": (WIRED, ["crucible.conductor.g4:paired_scores",
           ...
           "md` measured what that cost - 19 of 32 promoted rules do not close "
           "the breach they answer, recounted 2026-08-27 over 15 accepted "
           "bundles; it read `18 of 31` over 14 until `pilot-2026-08-25/run-08` "
           "finished writing and the reader began accepting it, and the finding "
           "got WORSE, 58.1 percent to 59.4 percent. WHAT THIS ROW DOES NOT "
           "SAY: WHICH SLICE b "
